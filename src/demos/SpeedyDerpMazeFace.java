...
public class SpeedyDerpMazeFace extends IRobotAdapter {
	//Sonar sonar = new Sonar();
	
	public SpeedyDerpMazeFace(IRobotInterface iRobot) {
		super(iRobot);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		SpeedyDerpMazeFace rob = new SpeedyDerpMazeFace(base);
		rob.setup();
		while(rob.loop()){}
		rob.shutDown();		
	}
